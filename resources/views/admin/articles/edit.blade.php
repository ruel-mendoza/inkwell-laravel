...
<div class="admin-wrapper">
    ...
    <main class="main-content">
        ...
        <div class="form-card">
            <form method="POST" action="{{ route('admin.articles.update', $article) }}" novalidate>
                @csrf
                @method('PUT')
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="text" name="category" id="category" value="{{ old('category', $article->category) }}" required>
                        @error('category')
                            <div class="form-error">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="form-group">
                    ...
                    <textarea name="excerpt" id="excerpt" placeholder="A brief summary...">{{ old('excerpt', $article->excerpt) }}</textarea>
                    @error('excerpt')
                        <div class="form-error">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="tags" id="tags" value="{{ old('tags', implode(', ', $article->tags ?? [])) }}" placeholder="e.g., laravel, web, tutorial">
                ...
                <div class="form-checkbox">
                    <input type="checkbox" name="featured" id="featured" @checked(old('featured', $article->featured))>
                ...
                <div class="form-actions">
                    ...
                    <form method="POST" action="{{ route('admin.articles.destroy', $article) }}" style="display: contents;" onsubmit="return confirm('Are you sure? This cannot be undone.');">
                        @csrf
                        @method('DELETE')
